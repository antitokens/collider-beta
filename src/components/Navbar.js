...
const Navbar = (trigger) => {
  ...
  const openPapersDropdown = () => {
    setIsPapersDropdownOpen(true);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 md:grid md:grid-cols-3 items-center flex justify-between">
        ...
        <div className="justify-self-start md:justify-self-center md:w-full">
          ...
          <div className="lg:hidden flex justify-center">
            <Link href="/" passHref legacyBehavior>
              <a className="flex items-center tracking-tight text-smer text-2xl font-semibold font-ocr bg-gradient-to-r from-accent-primary to-accent-secondary bg-clip-text text-transparent">
                Antitoken
          ...
          <div className="hidden lg:flex justify-center space-x-8">
            ...
            <div
              className="relative"
              onMouseEnter={openPapersDropdown}
            ...
            >
              <button className="text-gray-300 hover:text-accent-primary transition-colors flex items-center">
                ...
                <svg
                  ...
                  className={`h-4 w-4 ml-1 transition-transform ${
                    isPapersDropdownOpen ? "rotate-180" : ""
                  }`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
              ...
              <div
                className={`absolute w-48 bg-transparent h-2 ${
                  isPapersDropdownOpen ? "block" : "hidden"
                }`}
              ></div>
              {isPapersDropdownOpen && (
                <div className="absolute w-48 bg-dark-card border border-gray-800/50 rounded-lg mt-2 space-y-2 p-1">
                  ...
                  >
                    ...
                    <span className="tracking-tight text-sm">Whitepaper</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="tracking-tight text-sm">Yellowpaper</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="tracking-tight text-sm">Gitbook</span>
                  </a>
                </div>
              )}
            </div>
            ...
            >
              ...
              ></div>
              {isAppsDropdownOpen && (
                <div className="absolute w-64 bg-dark-card border border-gray-800/50 rounded-lg mt-2 space-y-2 p-1">
                  <a
                  ...
                  >
                    <div className="flex flex-row justify-between w-full">
                      <div className="flex flex-row gap-2">
                        ...
                        <span className="tracking-tight text-sm">Poll</span>
                      </div>
                      <div className="text-xs font-sfmono">
                        poll.antitoken.pro
                      </div>
                    </div>
                  </a>
                  <a className="flex items-center gap-2 block text-gray-400 hover:text-accent-primary transition-colors cursor-not-allowed">
                    <div className="flex flex-row justify-between w-full">
                      <div className="flex flex-row gap-2">
                        ...
                        <span className="tracking-tight text-sm">Lite</span>
                      </div>
                      <div className="text-xs font-sfmono">
                        lite.antitoken.pro
                      </div>
                  ...
                  >
                    <div className="flex flex-row justify-between w-full">
                      <div className="flex flex-row gap-2">
                        ...
                        <span className="tracking-tight text-sm">Pro</span>{" "}
                      </div>
                      <div className="text-xs font-sfmono">
                        app.antitoken.pro
                      </div>
              ...
              {isCommunityDropdownOpen && (
                <div className="absolute w-48 bg-dark-card border border-gray-800/50 rounded-lg mt-2 space-y-2 p-1">
                  ...
                  >
                    ...
                    <span className="tracking-tight text-sm">X/Twitter</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="tracking-tight text-sm">Telegram</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="tracking-tight text-sm">Forum</span>
                  </a>
                </div>
              )}
            </div>
